...
def _watch(bot: Bot, update, isTar=False):
    ...
    try:
        ...
        msg += f"\n\nExample :-\n<code>/{BotCommands.WatchCommand} https://youtu.be/v3cttbLue-w 720 |Akeno</code>\n\n"
        msg += "This file will be downloaded in 720p quality and it's name will be <b>Akeno</b>"
